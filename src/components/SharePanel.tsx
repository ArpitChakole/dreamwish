    ...
    <div className="w-full max-w-xl mx-auto space-y-8 no-print">
              ...
              <button
                ...
                className={`w-full sm:w-auto flex items-center justify-center gap-1.5 h-12 px-6 rounded-xl text-xs font-bold transition-all active-press-scale cursor-pointer shrink-0 ${
                  copied
                    ...
                    : 'bg-gradient-to-r from-violet-400 to-purple-400 hover:from-violet-500 hover:to-purple-500 text-white shadow-md'
                }`}
              >
                {copied ? (
                  <>
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-2">
        ...
        <a
          ...
          className="w-full sm:w-auto flex items-center justify-between gap-4 text-xs font-bold bg-gradient-to-r from-violet-400 to-purple-400 hover:from-violet-500 hover:to-purple-500 text-white pl-6 pr-3.5 py-3 rounded-full shadow-lg transition-all active-press-scale text-center cursor-pointer group"
        >
